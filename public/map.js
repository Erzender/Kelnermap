var app = new Vue({
  ...
  data: {
    ...
    settings: {
      ...
      nationName: "",
      image:
        "https://s1.qwant.com/thumbr/0x0/2/f/07b6960b07cf13295400fe43e0c2822a5effc4b4591c082a964b8505ed79e9/33505.jpg?u=http%3A%2F%2Femblemsbf.com%2Fimg%2F33505.jpg&q=0&b=1&p=0&a=1"
    }
  },
  computed: {
    colors: function() {
    ...
    nation: function() {
      ...
      return {
        ...
        image:
          ...
          "https://s1.qwant.com/thumbr/0x0/2/f/07b6960b07cf13295400fe43e0c2822a5effc4b4591c082a964b8505ed79e9/33505.jpg?u=http%3A%2F%2Femblemsbf.com%2Fimg%2F33505.jpg&q=0&b=1&p=0&a=1",
        desc:
          res && res.desc !== undefined && res.desc !== null ? res.desc : "",
    ...
    nations: function() {
      return this.control
        ...
        .filter(nation => nation.name || nation.areas.length !== 0)
  ...
  methods: {
            ...
            response.json().then(
              function(json) {
                ...
                this.settings.message =
                  "ℹ La requête a été enregistré, recopier le numéro de commande dans #territoires pour valider : " +
                  json.id;
              }.bind(this)
            );
          }.bind(this)
    ...
    settingsPlayerChange: function() {
      var player = this.control.find(
        elem => elem.id === this.settings.selectedPlayer
      );
      this.settings.name = player ? player.player : "";
      this.settings.soutiens = player
        ? player.soutiens.map(soutien => {
      ...
      this.settings.desc =
        !player || player.desc === undefined ? "" : player.desc;
      this.settings.image =
        !player || !player.image
          ? "https://s1.qwant.com/thumbr/0x0/2/f/07b6960b07cf13295400fe43e0c2822a5effc4b4591c082a964b8505ed79e9/33505.jpg?u=http%3A%2F%2Femblemsbf.com%2Fimg%2F33505.jpg&q=0&b=1&p=0&a=1"
          : player.image;
    ...
    settingsSoutienAdd: function(event) {
      ...
      var soutienP = this.control.find(
        elem => "" + elem.id === this.settings.toAddSoutien
      );
